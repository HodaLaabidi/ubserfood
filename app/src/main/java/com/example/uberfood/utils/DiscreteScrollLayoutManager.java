...
public class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    private com.example.uberfood.utils.DSVOrientation.Helper orientationHelper;
    ...
    @NonNull
    private final DiscreteScrollLayoutManager.ScrollStateListener scrollStateListener;
    ...
    public DiscreteScrollLayoutManager(
            @NonNull Context c,
            @NonNull DiscreteScrollLayoutManager.ScrollStateListener scrollStateListener,
    ...
    private void startSmoothPendingScroll() {
        LinearSmoothScroller scroller = new DiscreteScrollLayoutManager.DiscreteLinearSmoothScroller(context);
    ...
    public void onAdapterChanged(RecyclerView.Adapter oldAdapter, RecyclerView.Adapter newAdapter) {
        pendingPosition = NO_POSITION;
        scrolled = pendingScroll = 0;
        if (newAdapter instanceof DiscreteScrollLayoutManager.InitialPositionProvider) {
            currentPosition = ((DiscreteScrollLayoutManager.InitialPositionProvider) newAdapter).getInitialPosition();
        } else {
            currentPosition = 0;
        }
        recyclerViewProxy.removeAllViews();
    ...
    protected void setOrientationHelper(com.example.uberfood.utils.DSVOrientation.Helper orientationHelper) {
