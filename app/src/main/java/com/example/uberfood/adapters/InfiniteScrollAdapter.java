...
import com.example.uberfood.utils.DiscreteScrollLayoutManager;
...
public class InfiniteScrollAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T>
    ...
    public static <T extends RecyclerView.ViewHolder> com.yarolegovich.discretescrollview.InfiniteScrollAdapter<T> wrap(
            @NonNull RecyclerView.Adapter<T> adapter) {
        return new com.yarolegovich.discretescrollview.InfiniteScrollAdapter<>(adapter);
    }
    ...
    public InfiniteScrollAdapter(@NonNull RecyclerView.Adapter<T> wrapped) {
        ...
        this.wrapped.registerAdapterDataObserver(new InfiniteScrollAdapter.DataSetChangeDelegate());
    }
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        if (recyclerView instanceof DiscreteScrollView) {
            ...
            String msg = recyclerView.getContext().getString(com.yarolegovich.discretescrollview.R.string.dsv_ex_msg_adapter_wrong_recycler);
