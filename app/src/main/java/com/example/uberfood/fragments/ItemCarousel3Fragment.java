...
public class ItemCarousel3Fragment extends Fragment {
   ...
   // private DeliveryFragment.OnFragmentInteractionListener mListener;
    ...
    public static Fragment newInstance(Activity context, int position, float scale) {
        ...
        return Fragment.instantiate(context, ItemCarousel3Fragment.class.getName(), bundle);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =
                inflater.inflate(R.layout.item_carousel_3, container, false);

        int position = this.getArguments().getInt("position");


        CustomLinearLayout root = (CustomLinearLayout) view.findViewById(R.id.item_root);
        ImageView imageCarousel = view.findViewById(R.id.image_item_carousel_3);
